...
*OTHER READINGS:* Minimizing mistakes article (Rouder et al., 2019), [Github beginner guide](https://guides.github.com/activities/hello-world/)
...
- [Basic file import](TBD)
- [Multiple file import](TBD)
- [Import homework](TBD)
